...
### Trino Gateway 17 (xx Jan 2026) { id="17" }
...
* [:warning: Breaking change:](#breaking) Remove defunct email notifier.
...
* [:warning: Breaking change:](#breaking) Use and require Node.js v24.
