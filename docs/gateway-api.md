...
**Query History** page of the UI might not shows correctly.
...
updated based on the rule name.
...
You can set the `disablePages` configuration to deactivate pages on the UI.
