...
{
    public static Optional<BasicCredentials> extractBasicAuthCredentials(ContainerRequestContext request)
    ...
    @VisibleForTesting
    public static Optional<BasicCredentials> extractBasicAuthCredentials(String header)
            throws AuthenticationException
    {
