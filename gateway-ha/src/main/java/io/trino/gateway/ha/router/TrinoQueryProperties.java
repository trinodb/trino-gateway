...
public class TrinoQueryProperties
{
    ...
    private Optional<QualifiedName> procedure = Optional.empty();
    private List<SerializableCallArgument> procedureArguments = ImmutableList.of();
    ...
    public TrinoQueryProperties(
            ...
            @JsonProperty("procedureArguments") List<SerializableCallArgument> procedureArguments,
            ...
            throws RequestParsingException
    {
        switch (node) {
            ...
            case Call call -> {
                ...
                procedure = Optional.of(call.getName());
                procedureArguments = call.getArguments().stream().map(SerializableCallArgument::new).toList();
                return;
            }
    ...
    @JsonSerialize(using = SetQualifiedNameJsonSerializer.class)
    ...
    public boolean procedureNameEquals(String name)
    {
        return procedure.map(p -> {
            try {
                return qualifyName(p).equals(parseIdentifierStringToQualifiedName(name));
            }
            catch (RequestParsingException e) {
                return false;
            }
    ...
    @JsonIgnore
    public List<SerializableCallArgument> getProcedureArguments()
    {
        return procedureArguments;
    }

    @JsonProperty("procedure")
    @JsonSerialize(using = OptionalQualifiedNameJsonSerializer.class)
    public Optional<QualifiedName> getProcedure()
    {
        return procedure;
    }
    ...
    public static class SetQualifiedNameJsonSerializer
            extends StdSerializer<Set<QualifiedName>>
    {
        public SetQualifiedNameJsonSerializer()
        {
            this(null);
        }

        public SetQualifiedNameJsonSerializer(Class<Set<QualifiedName>> t)
        {
            super(t);
        }
    ...
    public static class OptionalQualifiedNameJsonSerializer
            extends StdSerializer<Optional<QualifiedName>>
    {
        public OptionalQualifiedNameJsonSerializer()
        {
            this(null);
        }

        public OptionalQualifiedNameJsonSerializer(Class<Optional<QualifiedName>> t)
        {
            super(t);
        }

        @Override
        public void serialize(Optional<QualifiedName> qualifiedName, JsonGenerator jsonGenerator, SerializerProvider serializerProvider)
                throws IOException
        {
