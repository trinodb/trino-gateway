        ...
        implements ContainerRequestFilter
{
            ...
            throws IOException
    {
        ...
        TrinoRequestUser user;
        try {
            user = trinoRequestUserProvider.getInstance(requestContext, servletRequest);
        }
        catch (IllegalArgumentException e) {
            // On exempt paths a browser may auto-present an unrelated cert, so fall back to header/cookie identity
