        ...
        implements ContainerRequestFilter
{
    ...
    @Inject
    public QueryUserInfoParser(HaGatewayConfiguration config)
    {
            ...
            throws IOException
    {
        ...
        if (!haGatewayConfiguration.isPathWhiteListed(path)) {
            return;
        }

        TrinoRequestUser user = new TrinoRequestUser.TrinoRequestUserProvider(haGatewayConfiguration.getRequestAnalyzerConfig()).getInstance(requestContext);
