 ...
 */
public abstract class CachingRoutingManager
        implements RoutingManager
{
    private static final Random RANDOM = new Random();
    private static final Logger log = Logger.get(CachingRoutingManager.class);
    ...
    public CachingRoutingManager(GatewayBackendManager gatewayBackendManager)
    {
    ...
    private boolean isBackendNotHealthy(String backendId)
    {
        if (backendToHealth.isEmpty()) {
            CachingRoutingManager.log.error("backends can not be empty");
            return true;
        }
