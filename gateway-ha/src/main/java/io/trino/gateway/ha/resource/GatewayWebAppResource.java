...
public class GatewayWebAppResource
{
    ...
    public Response getDistribution(QueryDistributionRequest query)
    {
        ...
        distributionResponse.setOfflineBackendCount(ObjectUtils.defaultIfNull(activeMap.get(false), Collections.emptyList()).size());
        distributionResponse.setOnlineBackendCount(ObjectUtils.defaultIfNull(activeMap.get(true), Collections.emptyList()).size());
