...
public class RoutingRulesConfiguration
{
    ...
    private RulesType rulesType = RulesType.valueOf("FILE");
    private String rulesConfigPath;
    private RulesRESTConfiguration rulesRESTConfiguration;
    ...
    public RulesRESTConfiguration getRulesRESTConfiguration()
    {
        return this.rulesRESTConfiguration;
    }

    public void setRulesRESTConfiguration(RulesRESTConfiguration rulesRESTConfiguration)
    {
        this.rulesRESTConfiguration = rulesRESTConfiguration;
    }
}
