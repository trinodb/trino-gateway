...
public class HttpUtils
{
    ...
    // Trino derives the session's original identity from this, so it is as identity-bearing as USER_HEADER
    public static final String ORIGINAL_USER_HEADER = "X-Trino-Original-User";
