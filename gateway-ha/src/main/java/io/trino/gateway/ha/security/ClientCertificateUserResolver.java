...
public final class ClientCertificateUserResolver
{
    ...
    public ClientCertificateUserResolver(RequestAnalyzerConfig config)
    {
        ...
        this.identityField = config.getClientCertificateIdentityField();
            ...
            throws UserMappingException
    {
        ...
        if (identityField == null || identityField.isBlank()) {
            throw new UserMappingException("clientCertificateIdentityField is not configured");
        }

        String rawIdentity;
        try {
            rawIdentity = ClientCertificateIdentityExtractor.extractIdentity(certificate.orElseThrow(), identityField)
