...
final class TestPreserveForwardedHeadersDisabled
{
            ...
            throws Exception
    {
        ...
        File testConfigFile =
                HaGatewayTestUtils.buildGatewayConfig(postgresql, routerPort, "test-config-with-preserve-forwarded-headers-disabled-template.yml");
        // Start Gateway
