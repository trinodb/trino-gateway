...
{
    @Test
    void testRestrictToOwnHistoryWhenFlagDisabledAndUserIsNotAdmin()
    {
    ...
    @Test
    void testUseProvidedUserFilterWhenFlagEnabledAndUserIsNotAdmin()
    {
        QueryHistoryManager queryHistoryManager = mock(QueryHistoryManager.class);
        when(queryHistoryManager.findQueryHistory(any())).thenReturn(new TableData<>(List.of(), 0));
    ...
    @Test
    void testUseProvidedUserFilterWhenUserIsAdmin()
    {
        QueryHistoryManager queryHistoryManager = mock(QueryHistoryManager.class);
        when(queryHistoryManager.findQueryHistory(any())).thenReturn(new TableData<>(List.of(), 0));
