...
final class TestJdbcConnectionManagerPool
{
            ...
            throws Exception
    {
        ...
        JdbcConnectionManager connectionManager = new JdbcConnectionManager(Jdbi.create(jdbcUrl, "sa", "sa"), configuration);
        Jdbi jdbi = connectionManager.getJdbi("testdb");
        ...
        try (ExecutorService executorService = Executors.newFixedThreadPool(3)) {
            ...
            for (Future<Connection> future : acquired) {
