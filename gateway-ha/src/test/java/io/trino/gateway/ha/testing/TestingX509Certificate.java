        ...
        extends X509Certificate
{
    ...
    // For attribute value encodings that the RFC 2253 string form cannot express
    public TestingX509Certificate(byte[] derEncodedSubject)
    {
        this.principal = new X500Principal(derEncodedSubject);
    }
