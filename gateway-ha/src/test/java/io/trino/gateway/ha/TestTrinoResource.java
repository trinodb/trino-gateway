...
final class TestTrinoResource
{
            ...
            throws Exception
    {
        ...
        DataStoreConfiguration db = new DataStoreConfiguration(postgresql.getJdbcUrl(), postgresql.getUsername(), postgresql.getPassword(), "org.postgresql.Driver", true, 4, true, null);
