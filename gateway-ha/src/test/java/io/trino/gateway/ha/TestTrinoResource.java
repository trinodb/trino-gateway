...
public class TestTrinoResource {
  ...
  @Test
  @Order(1)
  public void testReadResourceGroupsAll() throws Exception {
    Request request =
        new Request.Builder()
    ...
    assertEquals(1234, groups[0].getResourceGroupId());
    assertEquals(3456, groups[1].getResourceGroupId());
    assertEquals(5678, groups[2].getResourceGroupId());
  }

  @Test
  @Order(2)
  public void testReadResourceGroupsByGroupId() throws Exception {
    Request request =
        new Request.Builder()
    ...
    ResourceGroupsDetail[] resourceGroups =
        objectMapper.readValue(response.body().string(), ResourceGroupsDetail[].class);
    assertEquals(1, resourceGroups.length);

    assertEquals(1234, resourceGroups[0].getResourceGroupId());
  }

  @Test
  @Order(3)
  public void testReadSelectorsAll() throws Exception {
    Request request =
        new Request.Builder()
    ...
    assertEquals(1234, selectors[0].getResourceGroupId());
    assertEquals(3456, selectors[1].getResourceGroupId());
  }

  @Test
  @Order(4)
  public void testReadSelectorsByGroupId() throws Exception {
    Request request =
        new Request.Builder()
    ...
    assertEquals(3456, selectors[0].getResourceGroupId());
  }

  @Test
  @Order(5)
  public void testDeleteResourceGroupOk() throws Exception {
  ...
  @Test
  @Order(6)
  public void testDeleteResourceGroupNoId() throws Exception {
    RequestBody requestBody =
        RequestBody.create(MediaType.parse("application/json; charset=utf-8"), "");
    Request request =
        new Request.Builder()
  ...
  @Test
  @Order(7)
  public void testDeleteGlobalPropertyOk() throws Exception {
    RequestBody requestBody =
        RequestBody.create(MediaType.parse("application/json; charset=utf-8"), "");
    Request request =
        new Request.Builder()
  ...
  @Test
  @Order(8)
  public void testDeleteGlobalPropertyNoName() throws Exception {
    RequestBody requestBody =
        RequestBody.create(MediaType.parse("application/json; charset=utf-8"), "");
    Request request =
        new Request.Builder()
