...
final class TestTrinoResource
{
            ...
            throws Exception
    {
        ...
        DataStoreConfiguration db = new DataStoreConfiguration(postgresql.getJdbcUrl(), postgresql.getUsername(), postgresql.getPassword(), "org.postgresql.Driver", 4, true, true);
