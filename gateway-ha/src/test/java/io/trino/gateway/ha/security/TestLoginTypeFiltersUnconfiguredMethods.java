...
/**
 * Verifies that an authentication type listed in {@code authentication.defaultType}
...
final class TestLoginTypeFiltersUnconfiguredMethods
{
    ...
    void testLoginTypeOmitsUnconfiguredMethod()
            throws IOException
    {
        // oauth is listed first in defaultType but has no oauth block, so only form is usable.
